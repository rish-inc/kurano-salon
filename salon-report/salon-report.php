...
@include_once( 'view/personal-insert-customer-fields.php' );
...
@include_once( 'view/manage_store_products_columns.php' );
@include_once( 'model/main-save-customer-fields.php' );
@include_once( 'model/personal-save-customer-fields.php' );
@include_once( 'model/shop-save-term-fields.php' );
@include_once( 'model/store-products-save-term-fields.php' );
