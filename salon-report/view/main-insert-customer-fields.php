...
?>
	<div class="customer_form_field">
		...
		<div class="customer_form_field__item">
			...
			<input type="hidden" data-loop="12" id="<?php echo $handdraw_hidden['id'] ?>" name="<?php echo $handdraw_hidden['name'] ?>" class="js-handdraw-data" value="<?php echo get_post_meta( $post->ID, $handdraw_hidden['name'], true ); ?>">
		</div>
		<div class="customer_form_field__item">
